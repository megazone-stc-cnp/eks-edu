...
echo "envsubst < eksctl-cluster-nodegroup-with-ebs.yaml.template > template/eksctl.yaml"
echo ""
envsubst < eksctl-cluster-nodegroup-with-ebs.yaml.template > template/eksctl.yaml
