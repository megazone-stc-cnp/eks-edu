...
2. https://docs.aws.amazon.com/aws-managed-policy/latest/reference/AmazonEKS_CNI_Policy.html[AmazonEKS_CNI_Policy, window=_blank] IAM 정책 (IPv4 사용시 필요)
3. IPv6 사용을 위한 IAM 정책 (https://docs.aws.amazon.com/ko_kr/eks/latest/userguide/cni-iam-role.html#cni-iam-role-create-ipv6-policy[참고, window=_blank])
